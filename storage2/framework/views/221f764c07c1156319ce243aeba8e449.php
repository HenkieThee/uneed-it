...
<?php $component->withAttributes([]); ?>
    ...
    <main class="main-content">
        <div class="form-container">
            ...
            <form id="registration-form" action="<?php echo e(url('login')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\uneeditGoeie\resources\views/login.blade.php ENDPATH**/ ?>